    ...
    return(
        ...
        <div className="px-2 lg:mx-16 flex flex-wrap">
          <div className="w-full sm:w-1/2 md:w-1/2 my-auto lg:py-10">
            ...
            <p className=" text-3xl sm:tex-4xl md:text-5xl font-semibold line-height-sm">that <span>make sense</span></p>
            <button className="bg-green-400 mt-6 px-3 py-2 rounded-sm text-white hover:bg-green-500 text-center rounded-2xl shadow-lg">Start Now</button>
          </div>
